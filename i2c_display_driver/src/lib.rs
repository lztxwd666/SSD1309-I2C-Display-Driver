...
//! # 能力概览
//!
//! * [`display::Display`] — 顶层句柄：打开/推帧/局部推帧/自动恢复/对比度/反色/休眠/唤醒/水平与垂直滚动/旋转/高级寄存器控制
//! * [`display::DisplayBuilder`] — 链式初始化配置
//! * [`display::DisplayConfig`] — 可配置初始化（总线、地址、对比度/反色/显示开关/旋转/高级寄存器）
